      ...
      {isLoading ? (
        ...
        config && (
          <div className="flex flex-col space-y-6 pb-28 lg:pb-8">
            ...
            <SettingsSection title={t('Automatic Search')}>
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <p className="text-sm text-black/90 dark:text-white/90 font-medium">
                                    {t('Automatic Image Search')}
                                </p>
                                <p className="text-xs text-black/60 dark:text-white/60 mt-0.5">
                                    {t('Automatically search for relevant images in chat responses')}
                                </p>
                            </div>
                        </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-3 bg-light-secondary dark:bg-dark-secondary rounded-lg hover:bg-light-200 dark:hover:bg-dark-200 transition-colors">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <p className="text-sm text-black/90 dark:text-white/90 font-medium">
                                {t('Automatic Video Search')}
                            </p>
                            <p className="text-xs text-black/60 dark:text-white/60 mt-0.5">
                                {t('Automatically search for relevant videos in chat responses')}
                            </p>
                        </div>
                    </div>
                  <Switch
            ...
            <SettingsSection title={t('System Instructions')}>
                <div className="flex flex-col space-y-4">
                    <Textarea
                        value={systemInstructions}
                        placeholder={t('Any special instructions for the LLM')}
            ...
            <SettingsSection title={t('Model Settings')}>
                {config.chatModelProviders && (
                    <div className="flex flex-col space-y-4">
                        <div className="flex flex-col space-y-1">
                            <p className="text-black/70 dark:text-white/70 text-sm">
                                {t('Chat Model Provider')}
                            </p>
                    <Select
                              ...
                              options={(() => {
                                  ...
                                  return chatModelProvider
                                      ...
                                      : [
                                          {
                                              value: '',
                                              label: t('Invalid provider, please check backend logs'),
                                              disabled: true,
                                          },
                                          ];
                              })()}
                ...
                selectedChatModelProvider === 'custom_openai' && (
                  <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <Input
                            type="text"
                            placeholder={t('Custom OpenAI API Key')}
                    ...
                    <div className="flex flex-col space-y-1">
                        <p className="text-black/70 dark:text-white/70 text-sm">
                            {t('Custom OpenAI Base URL')}
                        </p>
                        <Input
                            type="text"
                            placeholder={t('Custom OpenAI Base URL')}
            ...
            <SettingsSection title={t('API Keys')}>
                <div className="flex flex-col space-y-4">
                    <div className="flex flex-col space-y-1">
                        <p className="text-black/70 dark:text-white/70 text-sm">
                            {t('OpenAI API Key')}
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <Input
                            type="text"
                            placeholder={t('LM Studio API URL')}
