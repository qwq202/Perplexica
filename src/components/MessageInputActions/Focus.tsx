  ...
  const focusModes = [
    {
      key: 'webSearch',
      title: t('All'),
      description: t('Searches across all of the internet'),
      icon: <Globe size={20} />,
    },
    {
      key: 'academicSearch',
      title: t('Academic'),
      description: t('Search in published academic papers'),
      icon: <SwatchBook size={20} />,
    },
    {
      key: 'writingAssistant',
      title: t('Writing'),
      description: t('Chat without searching the web'),
      icon: <Pencil size={16} />,
    },
    {
      key: 'wolframAlphaSearch',
      title: t('Wolfram Alpha'),
      description: t('Computational knowledge engine'),
      icon: <BadgePercent size={20} />,
    },
    {
      key: 'youtubeSearch',
      title: t('Youtube'),
      description: t('Search and watch videos'),
      icon: <SiYoutube className="h-5 w-auto mr-0.5" />,
    },
    {
      key: 'redditSearch',
      title: t('Reddit'),
      description: t('Search for discussions and opinions'),
    ...
    <Popover className="relative w-full max-w-[15rem] md:max-w-md lg:max-w-lg mt-[6.5px]">
      ...
      >
        {focusMode !== 'webSearch' ? (
          ...
          <div className="flex flex-row items-center space-x-1">
            <ScanEye size={20} />
            <p className="text-xs font-medium hidden lg:block">{t('Focus')}</p>
          </div>
        )}
      </PopoverButton>
      <Transition
